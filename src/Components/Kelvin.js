 ...
 return (
   <View style={styles.container}>
        ...
        <View style={styles.rowsArea}>
          <TouchableOpacity style={styles.row} onPress={() => navigate.navigate("CalcularKelvin", {temperatureUnit: "C"})}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => navigate.navigate("CalcularKelvin", {temperatureUnit: "F"})}>
